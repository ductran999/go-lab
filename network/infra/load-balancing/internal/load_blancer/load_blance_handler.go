...
import (
	...
	"go-lab/network/infra/load-balancing/internal/algorithms"
	"go-lab/network/infra/load-balancing/internal/errs"
...
//nolint:ireturn // factory picks one of several implementations by runtime value.
